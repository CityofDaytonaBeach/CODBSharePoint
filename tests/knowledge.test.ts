...
describe('CODBSharePoint - SharePoint knowledge catalog', () => {
  it('exposes broad SharePoint, Graph, schema, dependency, and deployment knowledge', () => {
    ...
    expect(summary.sharePointRest).toBeGreaterThanOrEqual(30);
    expect(summary.graph).toBeGreaterThanOrEqual(50);
    expect(summary.schema).toBeGreaterThanOrEqual(40);
    expect(summary.sourcePatterns).toBeGreaterThanOrEqual(25);
  ...
  it('feeds knowledge into SDK and AI prompt context', () => {
    ...
    expect(sdk.knowledgeAPI.summary().graph).toBeGreaterThanOrEqual(50);
    ...
    expect(context.capabilities.sharePointKnowledge.graph).toBeGreaterThanOrEqual(50);
